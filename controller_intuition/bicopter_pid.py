...
#
# Take the state to be k = (pq, q, 1/p e_q, px, x, py, y, 1/p e_y)
# where 
#   p = d/dt
...
#   *_r = set point for * 
#
# Consider pk = (p^2 q, pq, e_q, p^2 x, px, p^2 y, py, e_y)
...
#  Fsum = Kpy * e_y + Kdy * py + Kiy * ie_y             bounded to [0, max_thrust]
...
# 
# Notice we've neglected a few cross terms in these controllers, applying some physical intuition.
# 
...
class RigidBicopter:
    ...
    def __init__(self):        
        ...
        self.x_0 = -2 # m 
        self.y_0 = 4 # m
        self.k = asarray([0, 0, 0, 0, self.x_0, 0, self.y_0, 0])
    
    # This draws the line that is the bicopter
    def draw(self):        
        (pq, q, ie_q, px, x, py, y, ie_y) = self.k
    ...
    def pk(self, k_t, t):        
        ...
        return [p2q, pq, pie_q, p2x, px, p2y, py, pie_y]
...
ax.set_title("PID Controlled Bicopter")
ax.grid()
